...
// цветов сюда передаётся общая схема кнопок сайта — светлая тема 500,
// hover 600; тёмная 400, hover 500 (см. Button.tsx), например
// "bg-orange-500 hover:bg-orange-600 dark:bg-orange-400 dark:hover:bg-orange-500". В варианте
